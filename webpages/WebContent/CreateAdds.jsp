          ...
          <div class="col-md-12">
            ...
            <div class="content-page">
             <div class="col-md-7 col-sm-7">
					...
					<form class="form-horizontal" method="POST" action="CreateJobs">
						<fieldset>
							  <legend>Your personal details</legend>
							  <div class="form-group">
								<label for="firstname" class="col-lg-4 control-label">Title <span class="require">*</span></label>
								<div class="col-lg-8">
								  <input type="text" class="form-control" name="title">
								</div>
							  </div>
							  <div class="form-group">
								<label for="lastname" class="col-lg-4 control-label">Description <span class="require">*</span></label>
								<div class="col-lg-8">
								  <input type="text" class="form-control" name="description">
							   </div>
							  </div>
							   <div class="form-group">
								<label for="lastname" class="col-lg-4 control-label">Expiration_date <span class="require">*</span></label>
								<div class="col-lg-8">
							...
							<div class="row">
							  <div class="col-lg-8 col-md-offset-4 padding-left-0 padding-top-20">                     
								<button type="submit" class="btn btn-primary btn-apply"> Save Job</button>                    
							  </div>
							</div>				
					</form>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-sm-6 padding-top-10">
            2018 ÃÂ© Job Portal. ALL Rights Reserved. <a href="#">Privacy Policy</a> | <a href="#">Terms of Service</a>
          </div>
          <!-- END COPYRIGHT -->
          <!-- BEGIN PAYMENTS -->
