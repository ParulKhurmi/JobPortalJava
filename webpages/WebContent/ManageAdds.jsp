        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-9 col-sm-9">
            ...
            <div class="content-page">
             <h2>Welcome <b><% out.println((String)request.getSession().getAttribute("username"));
             %></b></h2>
			  ...
			  <%
					...
					try {
						stmt = con.prepareStatement("select * from jobs where employer_id=?");
						stmt.setInt(1, usrid);		
						System.out.println("----------------------------------------------------------employer_id is "+usrid+"-----------------------------");
						result = stmt.executeQuery();
						if(!result.isBeforeFirst()) {
							out.println("<h1> No Entries Found for"+usrid+" </h1>");
							} 
					else {
						while(result.next()) {									
							...
							out.println("<a class='btn btn-primary btn-apply' href='JobDetail.jsp?jobid="+result.getInt("jobid")+"'> Edit </a>");
							out.println("<a class='btn btn-primary btn-apply' href='JobDetail.jsp?jobid="+result.getInt("jobid")+"&delete=1'> Delete </a>");
							out.println("<a class='btn btn-primary btn-apply' href='JobSeekerList.jsp?jobid="+result.getInt("jobid")+"&jobname="+result.getString("title")+"'> View List of Job Seekers for this job </a></div>");
							}
						}
